<template>
  ...
  <!-- <canvas ref="canvas" style="width:100%">Canvas not supported.</canvas> -->
</template>
<script>
// import { archives_fullScreenAnimation } from "@/utils";
export default {
  mounted() {
    // archives_fullScreenAnimation(this.$refs.canvas);
  }
};
</script>
<style scoped>
...
@-webkit-keyframes symphony {
  50% {
    -webkit-transform: rotate(-180deg) translate3d(-100px, -100px, 0);
